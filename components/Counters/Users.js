...
export default function CountersUsers({ }) {
    ...
    return (
        <motion.div
            ...
            <UsersIcon />
            <p className="text-white text-3xl py-2">{inView && <CountUp start={215345} end={2789421} duration={1.3} />}</p>
            <p className="text-white text-base">Users</p>
        </motion.div>
    )
}