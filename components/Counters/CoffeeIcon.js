...
export default function CountersCoffee({ }) {
    ...
    return (
        <motion.div
            ...
            <CoffeeIcon />
            <p className="text-white text-3xl py-2">{inView && <CountUp start={36742} end={66321} duration={1} />}</p>
            <p className="text-white text-base">Coffee</p>
        </motion.div>
    )
}