...
export default function CountersAppStore({ }) {
    ...
    return (
        <motion.div
            ...
            <BrandAppStore />
            <p className="text-white text-3xl py-2">{inView && <CountUp start={128723} end={192438} duration={1} />}</p>
